...
#    Updated: 2022/11/23 16:11:35 by bmangin          ###   ########lyon.fr    #
#                                                                              #
# **************************************************************************** #
...
FILES_COMMAND		:= NICK PASS JOIN USER VERSION MODE LIST OPER AWAY PING PRIVMSG ME KICK NAMES BAN
...
HEADER				:= ${addprefix ${PATH_I}/, ${addsuffix .hpp, ${FILES} ${FILES_REPLY}}}
